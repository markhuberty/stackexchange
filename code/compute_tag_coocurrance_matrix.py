...
cooc_object = {'tag_matrix': cooc_matrix,
...
row_indices, col_indices = cooc_matrix.nonzero()
eps = 0.00001
edges = [(unique_tags[r], unique_tags[c], 1-cooc_matrix[r,c] + eps)
         if cooc_matrix[r,c] > cooc_matrix[c,r] else
         (unique_tags[c], unique_tags[r], 1-cooc_matrix[c,r] + eps)
